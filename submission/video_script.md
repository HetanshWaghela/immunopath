...
> "We iterated through three versions. Our TIL prediction meets its clinical target — an MAE of 0.16, below the 0.20 threshold. JSON compliance went from 16% in zero-shot to 100% in all fine-tuned versions — a 6× improvement showing production-ready structured output."
